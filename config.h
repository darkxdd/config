...
static char *fonts[]          = { "Overpass Nerd Font:size=13", "AppleColorEmoji:pixelsize=15:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ 0, XF86MonBrightnessUp,	spawn,		{.v = (const char*[]){ "brightnessctl", "s", "+15%", NULL } } },
	{ 0, XF86MonBrightnessDown,	spawn,		{.v = (const char*[]){ "brightnessctl", "s", "15%-", NULL } } },
